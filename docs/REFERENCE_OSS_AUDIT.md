...
| `nexu-io/open-design` | local reference clone | Apache-2.0 | Multilingual README/docs, translation guide, screenshot-heavy OSS README, issue/PR scaffolding, agent-native local design workflow. | OSS growth patterns only; no code or assets copied. |
