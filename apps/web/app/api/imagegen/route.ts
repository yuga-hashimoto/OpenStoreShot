...
export async function POST(request: Request): Promise<Response> {
  ...
  return NextResponse.json({
    ...
    mock: true,
    message: "OpenStoreShot本体はAPIキーを使いません。AIエージェントで作った案をローカルで確認するためのプレビューです。"
  });
}
